...
class ASLTrainerApp:
    ...
    def _train_model_thread(self):
        ...
        datagen = ImageDataGenerator(
            ...
            width_shift_range=0.2,  # Move hand left/right
            height_shift_range=0.2,  # Move hand up/down
            zoom_range=0.2,  # Zoom in/out
            horizontal_flip=True  # Flip hands (except for letters that aren't symmetrical)
        )
        ...
        ModelCode = r"C:\Users\User\OneDrive\Documents\SignLanguageApp\TrainedBinaryModels"
        save_path = os.path.join(ModelCode, f"{model_name}_model.h5")
