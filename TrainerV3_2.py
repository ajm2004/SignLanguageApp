...
# ---------------------------
# These methods are added to generate a Grad-CAM heatmap overlay for a sample image.
...
class ASLTrainerApp:
    ...
    def _train_model_thread(self):
        ...
        # BasicCNN uses a small size; Xception and InceptionV3 use 299x299; all others use 224x224.
        if model_name == "BasicCNN":
            img_size = (64, 64)
        ...
        # ---------------------------
        try:
            # Pick the first class folder and the first image inside it as an example
            ...
            if len(class_folders) > 0:
                ...
                if sample_img is not None:
                    ...
                    print("No image found in the sample class folder for Grad-CAM.")
            else:
                print("No class folders found in the dataset directory.")
        except Exception as e:
            print("Error generating Grad-CAM heatmap:", e)
    ...
    def generate_and_save_gradcam_heatmap(self, model, sample_img_path, img_size, model_name, results_folder):
        ...
        if last_conv_layer_name is None:
            print("No convolutional layer found in the model; Grad-CAM cannot be applied.")
            return
